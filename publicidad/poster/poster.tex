...
\lhead{\hspace{0.1cm}\includegraphics[width=.18\textwidth]{pisis.png}}

\lfoot{\hspace{1cm}\includegraphics[width=.22\textwidth]{logotipo-uanl-prefooter.png}}
\cfoot{\hspace{3cm}\includegraphics[width=.12\textwidth]{logotipo-vision-2030.png}}
\rfoot{\includegraphics[width=.08\textwidth]{fime_gris.png}\hspace{0.2cm}}
%-----------------------------------------------------
% Poster Content
%-----------------------------------------------------
\pagestyle{fancy}
